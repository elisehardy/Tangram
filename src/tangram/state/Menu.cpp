...
namespace tangram::state {
    ...
    void Menu::init() {
        ...
        auto new_game = std::make_shared<gui::Button>(
        ...
        auto create = std::make_shared<gui::Button>(
            ...
            MLV_COLOR_GREY40, MLV_COLOR_BLACK, MLV_COLOR_GREY40,
            MLV_TEXT_CENTER, MLV_HORIZONTAL_CENTER, MLV_VERTICAL_CENTER,
            [](game::Engine &e) { e.pushState(Create::getInstance()); }
        );
        auto edit = std::make_shared<gui::Button>(
            ...
            MLV_COLOR_GREY40, MLV_COLOR_BLACK, MLV_COLOR_GREY40,
            MLV_TEXT_CENTER, MLV_HORIZONTAL_CENTER, MLV_VERTICAL_CENTER,
            [](game::Engine &e) { e.pushState(Load::getInstance()); }
        );
        auto quit = std::make_shared<gui::Button>(
